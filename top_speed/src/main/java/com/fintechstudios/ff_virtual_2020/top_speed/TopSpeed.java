 ...
 * @see <a href="https://github.com/apache/flink/blob/master/flink-examples/flink-examples-streaming/src/main/java/org/apache/flink/streaming/examples/windowing/TopSpeedWindowing.java"/>
 */
public class TopSpeed {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final ParameterTool params = StandardConfiguration.fromArgs(args);
